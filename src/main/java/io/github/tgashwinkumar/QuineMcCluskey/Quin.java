...
public class Quin {
    ...
    private int findbitchange(String a, String b) {
        int ind = -1;
    ...
    private String findbinary(int num, int nobits) {
        String s = "";
        while (num > 0) {
            int rem = num % 2;
            s += rem;
    ...
    public void showSimplification(int[] n){
        step1(n);
    }

    private void step1(int[] n) {
        int size = n.length;
    ...
    private String[][] step2(String[][] arr, int nobits) {
                ...
                for (int a = st + 1; a < st + 2; a++) {
                    for (int b = 0; b < arr[0].length; b++) {
                        ...
                        if (c != -1) {
                            ...
                            map.put(s2a,
                                    new ArrayList<Integer>(Arrays.asList(decimal(arr[a][b]), decimal(arr[st][en]))));
                            int e = 0;
                            while (e < s2[0].length) {
                                if (s2[st][e] == null) {
                                    s2[st][e] = s2a;
    ...
    private String[][] step3(String[][] arr, int nobits) {
        String[][] s2 = new String[arr.length][arr.length];
        int check = 0;
        int i = 0, j = 0, st = -1, en = -1;
        while (true) {
